...
<link rel="stylesheet" href="{{ADMIN_ASSET}}plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
<!-- dropzonejs -->
<link rel="stylesheet" href="{{ADMIN_ASSET}}plugins/dropzone/min/dropzone.min.css">
<!-- Toastr -->
<link rel="stylesheet" href="{{ADMIN_ASSET}}plugins/toastr/toastr.min.css">